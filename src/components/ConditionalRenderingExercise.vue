    ...
    <div class="row">
      <div class="col-12">
        ...
        <div class="border p-1">
          ...
          <div class="player-card text-center area" v-show="state.player.show">
            <div>
              <img :src="state.player.photo" />
            </div>
            <div>
